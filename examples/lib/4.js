...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _xinix_xin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @xinix/xin */ \"../../index.js\");\n/* harmony import */ var _xinix_xin_components_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @xinix/xin/components/view */ \"../../components/view/index.js\");\n\n\n\nclass XBinding extends _xinix_xin_components_view__WEBPACK_IMPORTED_MODULE_1__[\"View\"] {\n  get template () {\n    return __webpack_require__(/*! ./x-binding.html */ \"./views/x-binding.html\");\n  }\n\n  get props () {\n    return Object.assign({}, super.props, {\n      foo: {\n        type: String,\n        value: '',\n      },\n    });\n  }\n}\n\nObject(_xinix_xin__WEBPACK_IMPORTED_MODULE_0__[\"define\"])('x-binding', XBinding);\n\n\n//# sourceURL=webpack:///./views/x-binding.js?");
