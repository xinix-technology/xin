...
var map = {
	"./android-icon-144x144.png": 65,
	"./android-icon-192x192.png": 66,
	"./android-icon-36x36.png": 67,
	"./android-icon-48x48.png": 68,
	"./android-icon-72x72.png": 69,
	"./android-icon-96x96.png": 70,
	"./apple-icon-114x114.png": 71,
	"./apple-icon-120x120.png": 72,
	"./apple-icon-144x144.png": 73,
	"./apple-icon-152x152.png": 74,
	"./apple-icon-180x180.png": 75,
	"./apple-icon-57x57.png": 76,
	"./apple-icon-60x60.png": 77,
	"./apple-icon-72x72.png": 78,
	"./apple-icon-76x76.png": 79,
	"./apple-icon-precomposed.png": 80,
	"./apple-icon.png": 81,
	"./favicon-16x16.png": 82,
	"./favicon-32x32.png": 83,
	"./favicon-96x96.png": 84,
	"./ms-icon-144x144.png": 85,
	"./ms-icon-150x150.png": 86,
	"./ms-icon-310x310.png": 87,
	"./ms-icon-70x70.png": 88
};
...
__webpack_require__(21); // eslint-disable-line import/no-webpack-loader-syntax

__webpack_require__(24);
__webpack_require__(25);

__webpack_require__(23); // eslint-disable-line import/no-webpack-loader-syntax
let file = 'index';
__webpack_require__(17)("./" + file + '.md');
__webpack_require__(16)("./" + file + '.md');
__webpack_require__(18)("./" + file + '.md');

__webpack_require__(19); // eslint-disable-line import/no-webpack-loader-syntax
__webpack_require__(20); // eslint-disable-line import/no-webpack-loader-syntax
file = 'apple-icon';
__webpack_require__(15)("./" + file + '.png');

let next = Promise.resolve();
if ('fetch' in window === false) {
  next = next.then(() => __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 100)));
}

if ('customElements' in window === false) {
  next = next.then(() => __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 58)));
}
...
next.then(() => __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 59)));
...
// module
exports.push([module.i, "html.fit, html.fit body {\n  height: 100%;\n  padding: 0;\n  margin: 0;\n}\n\n.layout {\n  height: 100%;\n  weight: 100%;\n\n  display: -webkit-box;\n  display: box;\n  display: -webkit-flex;\n  display: flex;\n\n  -webkit-box-orient: vertical;\n  box-orient: vertical;\n\n  -webkit-flex-direction: column;\n  flex-direction: column;\n}\n\n.layout.horizontal {\n  -webkit-box-orient: horizontal;\n  box-orient: horizontal;\n\n  -webkit-flex-direction: row;\n  flex-direction: row;\n}\n\n.layout .flex {\n  -webkit-box-flex: 1;\n  box-flex: 1;\n\n  -webkit-flex: 1;\n  flex: 1;\n}\n", ""]);
